                                    ...
                                    <div class="flex flex-wrap mt-4 -mx-3">
                                        <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                            ...
                                            <form class="max-w-xs mx-auto">
                                                ...
                                                <div class="relative flex items-center max-w-[8rem]">
                                                    ...
                                                    <input type="text" name="amount" id="quantity-input"
                                                        value="{{ old('amount', $book->amount) }}" data-input-counter
                                        ...
                                        <div class="w-full max-w-full px-3 mt-4 flex-0 sm:mt-0 sm:w-6/12">
                                            ...
                                            <textarea id="description" rows="4" name="description"
                                                ...
                                                placeholder="Write your thoughts here...">{{ old('description', $book->description) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="flex mt-6">
                                        <button type="submit"
